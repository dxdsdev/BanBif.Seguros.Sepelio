...
{
    public class RegistroTerceroController : Controller
    {
        // GET: RegistroTercero
        ...
        public ActionResult CalcularEdad(TercerosBE terceros)
        {

            var fechaNacimiento = DateTime.Parse(terceros.FechaNacimiento);
